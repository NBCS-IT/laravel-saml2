...
trait RendersTenants
{
     ...
     *
     * @param \NBCSIT\Saml2\Models\Tenant|\Illuminate\Support\Collection $tenants
    ...
    {
        /** @var \NBCSIT\Saml2\Models\Tenant[]|\Illuminate\Database\Eloquent\Collection $tenants */
     ...
     *
     * @param \NBCSIT\Saml2\Models\Tenant $tenant
     *
     * @return array
     */
